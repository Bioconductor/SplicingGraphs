...
#|   CIB3 (Entrez ID 117286). Left: transcript representation.
#|   Right: splicing graph representation. Orange arrows are edges
#|   corresponding to exons.
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("images/CIB3-transcripts.pdf")
knitr::include_graphics("images/CIB3-sg.pdf")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("images/ZNF813-transcripts.pdf")
knitr::include_graphics("images/ZNF813-sg.pdf")
```
...
#|   and can be removed. Left: before removal of the uninformative nodes.
#|   Right: after their removal.
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("images/CIB3-sg.pdf")
knitr::include_graphics("images/CIB3-sg2.pdf")
```
...
```{r}
#| label: plot-transcripts-sg-3183
#| eval: false
...
```{r}
#| label: plot-transcripts-sg-3183-as-pdf
#| echo: false
#| results: 'hide'
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("3183-transcripts.pdf")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("3183-sgraph.pdf")
knitr::include_graphics("3183-sgraph-labelled.pdf")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("7597-sgraph-labelled.pdf")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("4287-sgraph.pdf")
```
...
```{r}
#| label: plot-transcripts-sg-3183-and-reads
#| eval: false
...
```{r}
#| label: plot-transcripts-sg-3183-and-reads-as-pdf
#| echo: false
#| results: 'hide'
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("3183-transcripts-and-reads.pdf")
```
...
```{r}
#| label: plot-transcripts-sg-3183-and-reads-zoom
#| eval: false
plotTranscripts(sg[["3183"]], reads=junction_reads, from=21698400, to=21698600)
```

```{r}
#| label: plot-transcripts-sg-3183-and-reads-zoom-as-pdf
#| echo: false
#| results: 'hide'
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics("3183-transcripts-and-reads-zoom.pdf")
```
