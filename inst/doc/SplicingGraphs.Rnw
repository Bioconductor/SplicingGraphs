...
\begin{figure}[tbp]
  ...
  \hskip 0.5in
  \raisebox{-0.6in}{\includegraphics[width=2in,height=5.5in]{ZNF813-sg.pdf}}
...
[FIXME: The following statement is not true.] Between two remaining vertices
there exists at least two edges which form a bubble. Such a bubble,
representing an alternative splicing event, consists at least of two bubble
parts. The exonic structures of the two bubble parts are exclusive.
