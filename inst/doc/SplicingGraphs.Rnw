...
of all known transcript variants of gene CIB3 (Entrez ID 117286).
The green dashed lines in Figure \ref{img:CIB3} represent
genomic locations where exons start or end during the splicing graph
construction process.

\begin{figure}[H]
  \begin{center}
  \includegraphics[width=4in,height=1.5in,angle=90,origin=lB]{CIB3-gene.pdf}
  \hskip 0.5in
  \raisebox{-0.6in}{\includegraphics[width=2in,height=5.5in]{CIB3-sg.pdf}}
  %\includegraphics[width=2in,height=6in]{CIB3-sg2.pdf}
  \end{center}
  \caption{Splicing graph representation of the four transcript variants
    ...
    Edges are labeled with the transcript ids (or names), in blue. The green
    arrows are edges corresponding to exons.
  }
  \label{img:CIB3}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=4in,height=1.5in,angle=-90,origin=rB]{ZNF813-gene.pdf}
  \hskip 0.5in
  \raisebox{-0.5in}{\includegraphics[width=2in,height=5.5in]{ZNF813-sg.pdf}}
  %\includegraphics[width=2in,height=6in]{ZNF813-sg2.pdf}
  \end{center}
  \caption{Splicing graph representation of the two transcript variants
    of gene ZNF813 (Entrez ID 126017). Node $3$ is a two-type vertex:
